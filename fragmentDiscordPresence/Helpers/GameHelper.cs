...
namespace fragmentDiscordPresence
{
    public static class GameHelper
    {
        ...
        public static IntPtr GetPcsx2Offset(Process process,MemorySharp mem)
        {
            bool isWow64 = true;
            ...
            if (isWow64)
            {
                return (IntPtr)PCSX2_32BIT_ADDRESSPTR;
            }
            else
            {
                return (IntPtr)mem.Modules.MainModule.FindFunction("EEmem").Read<long>();
            }
